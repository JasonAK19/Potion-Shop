...
public:
    ...
    // Post conditions - Returns index of ingredient if the Shop has it else -1
    ...
    // Post conditions - Add an ingredient to the Shop's m_myIngredients with a quantity of 0
    ...
    // Preconditions - The shop exists, m_myIngredients populated
    // Post conditions - Displays name, ingredient count, total ingredients, percentage, and rank
